...
//
//   NOODL_REMOTE_DEBUG_PORT=9333 node drive-color.js --expect=<scratch copy dir> [--out=<dir>] [--no-input]
const fs = require('fs');
...
(async () => {
  ...
  fs.writeFileSync(path.join(outDir, 'color-results.json'), JSON.stringify(results, null, 2));
