...
| id | task | source | depends on |
|---|---|---|---|
| [CHR-007](./CHR-007-THE-ROWS-BECOME-DESCRIPTORS.md) | `Ports` becomes a pure function from a port list to row descriptors; the 40-branch dispatch becomes a registry; **behaviour-identical**, pinned by the existing panel specs as characterisation | audit §4 | CHR-001 |
