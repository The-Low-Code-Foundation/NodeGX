...
drive left behind, read against `cline-dev` HEAD `55dd19523`. **Status: 📋 building — HLT-001 ✅, HLT-002 ✅, HLT-003 ✅, HLT-004 ✅, HLT-006 ✅ (AC5 ruled WORTHY), five to go (plus HLT-011, HLT-012 and HLT-013, opened by HLT-003, HLT-006 and HLT-004).
Prefix: `HLT`.**
