...
| AC8 the bounded claim | 🟡 | **published** — `docs/runtime/SCALING.md` §"SQLite and Postgres" rewritten in R2's words. **Richard has not yet read and ruled it honest**, which is what the AC asks for |

### 8.1 ⚠️ AC8 touched a peer's uncommitted file
