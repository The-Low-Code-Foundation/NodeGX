...
| R21 | the MCP kit extractor cannot be reused for module node types. **s18:** kit wires are now counted unchecked, which is honest without it; the question is only whether to check them | [GAM-024](GAM-024-THE-DEPLOY-CENSUS-REPORTS-ONLY-REAL-DROPS.md) |
