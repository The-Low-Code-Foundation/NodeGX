...
| R20 | When the deploy's honest filter drops a wire: refuse, deploy and warn, or deploy unfiltered and warn? | [GAM-023](GAM-023-A-DEPLOY-REFUSES-A-BROKEN-WIRE-AND-KEEPS-EVERY-GOOD-ONE.md) |
