...
This component is used to check for a custom media query. It is mostly used for one-off edge cases. For general media query usage it is recommended to use the **[Match Media Query](/docs/library/prefabs/media-query/components/match-media-query)** component.
