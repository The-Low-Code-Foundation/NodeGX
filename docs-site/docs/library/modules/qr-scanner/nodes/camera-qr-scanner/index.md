...
The **Camera QR Scanner** node is used to open the camera view finder and scan for QR codes. It uses a [Video](/docs/nodes/visual/video) node to display the camera stream.
