...
The **Validate** node is used to validate data provided as inputs to the node based on a specified _schema_. This is most commonly used to validate input forms, learn more in the [guide](/docs/library/modules/validation).
...
Learn more about the schema script in the validation [guide](/docs/library/modules/validation).
...
You can also provide an object to be valided via the **Object Id** input. See the [guide](/docs/library/modules/validation) for more details.
...
There is also an array with a collection of all errors on the **Errors** output. See the [guide](/docs/library/modules/validation) for more details.
