 ...
 *   half hour you decided against is noise; a project, a month's plan, a cash event and the
 *   settings are not deletable by anything in this app, and the backend would refuse.
 *
